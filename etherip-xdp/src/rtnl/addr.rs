...
impl AddressManager {
    ...
    pub async fn get_v6(
        ...
        scope: V6AddressRequestScope,
    ) -> Result<Vec<std::net::Ipv6Addr>, std::io::Error> {
            ...
            .map_err(|e| std::io::Error::other(e))?
        {
            ...
            if response.header.scope
                != match scope {
                    V6AddressRequestScope::Global => {
                        netlink_packet_route::address::AddressScope::Universe
                    }
                    V6AddressRequestScope::LinkLocal => {
                        netlink_packet_route::address::AddressScope::Link
                    }
                }
            {
                continue;
